...
export default function IndexPage() {
  ...
  const personSchema = {
    ...
    jobTitle: "Software Developer & Robotics Engineer",
    sameAs: [siteConfig.links.github, siteConfig.links.twitter],
  };

  // Structured data for website as a portfolio
  const softwareSchema = {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Anuj Patil Portfolio",
    applicationCategory: "Portfolio",
    url: siteConfig.url,
    about: {
      "@type": "Thing",
      name: "Robotics Engineering and AI/ML Development",
    },
    author: {
      "@type": "Person",
      name: siteConfig.authorName,
  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-2 text-center mt-4">
          ...
          <AnimatedText
            as="h1"
            delay={0.2}
            className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl mt-2"
          >
            Anuj Patil
          </AnimatedText>
          <AnimatedText
            as="h3"
            delay={0.4}
            className="font-heading text-base sm:text-xl md:text-xl lg:text-2xl mt-1"
          >
          ...
          <div className="flex flex-col mt-6 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                ...
                aria-label="View Anuj Patil's GitHub profile"
              >
